...
export const ACCOUNT_HELPER_URL = process.env.REACT_APP_ACCOUNT_HELPER_URL || 'http://18.163.245.22:3002'
...
export const NODE_URL = process.env.REACT_APP_NODE_URL || 'http://13.250.204.142:3030'

const KEY_UNIQUE_PREFIX = '_4:'
const KEY_WALLET_ACCOUNTS = KEY_UNIQUE_PREFIX + 'wallet:accounts_v2'
const KEY_ACTIVE_ACCOUNT_ID = KEY_UNIQUE_PREFIX + 'wallet:active_account_id_v2'
const ACCESS_KEY_FUNDING_AMOUNT = process.env.REACT_APP_ACCESS_KEY_FUNDING_AMOUNT || '10250022915814882140000'
...
class Wallet {
    ...
    async createNewAccount(accountId, fundingKey, fundingContract) {
	    ...
	    console.log("create online ok",accountId);
