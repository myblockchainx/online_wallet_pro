...
export const ACCOUNT_HELPER_URL = process.env.REACT_APP_ACCOUNT_HELPER_URL || 'http://47.57.7.136:3002'
...
export const NODE_URL = process.env.REACT_APP_NODE_URL || 'http://18.163.196.118:3030'
